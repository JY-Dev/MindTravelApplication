...
import com.jydev.mindtravelapplication.ui.main.consulting.ConsultingFragment
...
class MainViewPagerAdapter(fa : FragmentActivity) : FragmentStateAdapter(fa) {
    private val fragmentList = arrayListOf(TravelFragment(),ConsultingFragment(), MindShareFragment())
